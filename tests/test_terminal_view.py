"""Tests for terminal_view.list_jobs / render_jobs (the `applypilot jobs` command)."""
...
class TestListJobs:
    def test_min_fit_filters_out_lower_scores(self, scratch_db):
        from applypilot.terminal_view import list_jobs
...
class TestRenderJobs:
    def test_empty_list_does_not_crash(self):
        from applypilot.terminal_view import render_jobs
