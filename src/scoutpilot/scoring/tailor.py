...
from scoutpilot.config import RESUME_PATH, TAILORED_DIR, get_locale_style, load_profile
...
from scoutpilot.scoring.pdf import split_sections
...
def check_no_cross_section_duplicates(resolved_data: dict, fact_bank: "FactBank | None" = None) -> None:
    ...
    ScoutPilot bullets under a single PROJECTS entry, or the two EMG
...
def _facts_available_for_entry(entry: dict, relevant: list) -> list:
    ...
    "emg", "scoutpilot"), i.e. the employer or project it actually
...
def _tailor_one_job(conn, job: dict, resume_text: str, profile: dict,
    ...
    from scoutpilot.enrichment.detail import check_listing_still_open
