...
from scoutpilot.config import DB_PATH
from scoutpilot.database import get_connection, init_db, ensure_columns
...
def set_proxy(proxy_str: str | None):
    ...
    if proxy_str:
        from scoutpilot.discovery.jobspy import parse_proxy
...
def _load_base_urls() -> dict[str, str | None]:
    ...
    from scoutpilot.config import load_base_urls
...
def extract_with_llm(page, url: str) -> dict:
    ...
    try:
        ...
        from scoutpilot.discovery.smartextract import extract_json
